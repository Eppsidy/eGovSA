...
const styles = StyleSheet.create({
  ...
  headerBar: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 18, paddingTop:30, paddingBottom: 10, backgroundColor: '#1A2B4A', ...shadow },
