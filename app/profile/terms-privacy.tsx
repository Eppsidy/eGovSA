    ...
    <View style={styles.page}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subheading}>4. Acceptable Use</Text>
          <Text style={styles.paragraph}>
            You agree NOT to:{'\n'}
          ...
          <Text style={styles.subheading}>5. Services Provided</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>6. Service Availability</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>7. Fees and Payments</Text>
          <Text style={styles.paragraph}>
          ...
          {/* PRIVACY POLICY */}
          <Text style={[styles.sectionHeader, styles.marginTop]}>Privacy Policy</Text>
          ...
          <Text style={styles.subheading}>2. How We Collect Information</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>3. Purpose of Collection</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>4. Information Sharing</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>7. Your Rights (Under POPIA)</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>8. Cookies and Tracking</Text>
          <Text style={styles.paragraph}>
            We use:{'\n'}
          ...
          <Text style={styles.subheading}>9. Children's Privacy</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>10. Data Breach Notification</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>11. Contact Us</Text>
          <Text style={styles.paragraph}>
          ...
          <Text style={styles.subheading}>12. Consent</Text>
          <Text style={styles.paragraph}>
