...
const styles = StyleSheet.create({
  ...
  logoCircle: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#de6c0fff', alignItems: 'center', justifyContent: 'center', marginRight: 10 },
  logoText: { fontSize: 12, fontWeight: '700', color: '#ffffffff' },
  ...
  welcomeCard: { margin: 16, padding: 16, backgroundColor: '#de6c0fff', borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 12, ...cardShadow },
  avatar: { width: 34, height: 34, borderRadius: 17, backgroundColor: '#de6c0fff', alignItems: 'center', justifyContent: 'center' },
